...
def test_to_receipt():
    ...
    assert LineItem(sku="123", unit_price=Decimal("20.00"), qty=2) in receipt.lignes 
    assert LineItem(sku="456", unit_price=Decimal("15.00"), qty=4) in receipt.lignes 
    assert LineItem(sku="678", unit_price=Decimal("50.00"), qty=2) in receipt.lignes 
